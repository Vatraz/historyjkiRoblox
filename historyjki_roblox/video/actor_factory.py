...
class Actor:
    ...
    def __init__(self, character: Character, position_number: int, text_color: str, is_lector: bool):
...
class ActorVideoIntervalSetFactory:
    def __init__(self):
        ...
        self.colors = ['AliceBlue', 'SpringGreen4', 'orchid2', 'pink', 'MintCream', 'crimson']
    ...
    def create_actor(self, name: str, position_number: int, character: Optional[Character] = None, is_lector: bool = False) -> Actor:
